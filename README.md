...
# 🧭 Curso: Construcción de Compiladores — UVG 2026

Bienvenidos al repositorio principal del curso de **Construcción de Compiladores** de la **Universidad del Valle de Guatemala** (UVG), año 2026.
...
```bash
git clone https://github.com/gbrolo/compilers-2026.git
cd compilers-2026
```
